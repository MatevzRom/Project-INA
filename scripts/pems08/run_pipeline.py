...
LABELS_PATH  = PROCESSED / "labels"   / "pems08_speed_labels.npy"
VFREE_PATH   = PROCESSED / "labels"   / "pems08_v_free.npy"
LABELS_META  = PROCESSED / "labels"   / "pems08_labels_meta.json"
FEATURES_NPZ = PROCESSED / "features" / "pems08_features.npz"
METRICS_PATH = Path("reports") / "pems08_baselines.json"
...
v_free        = np.percentile(spd[:train_end], FREE_FLOW_PCTILE, axis=0)
...
LABELS_META.write_text(json.dumps({
    ...
    "free_flow_percentile": FREE_FLOW_PCTILE,
